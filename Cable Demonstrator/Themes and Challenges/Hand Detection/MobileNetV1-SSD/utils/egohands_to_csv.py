...
def get_bbox_visualize(base_path, dir):
    ...
    for first in polygons:
        ...
        boxarray = []
        csvholder = []
        for i, pointlist in enumerate(first):
            # Set hand
            hand = ""
...
def final_finish():
    ...
    os.chdir("/Users/Byakugan/GitHub/MobileNetV1-SSD/data/egohands/egohands_data/")
    cwd = "/Users/Byakugan/GitHub/MobileNetV1-SSD/data/egohands/egohands_data/"
...
def main():
    ...
    EGO_HANDS_FILEPATH = "data/egohands/egohands_data/"

    #download_egohands_dataset(EGO_HANDS_FILEPATH)
    rename_files("/Users/Byakugan/GitHub/MobileNetV1-SSD/data/egohands/egohands_data/_LABELLED_SAMPLES/")
    create_label_map()
    final_finish()
