# This code is borrowed from 'https://github.com/ultralytics/yolov3/'
import argparse
import json
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/egohands/egohandsDarknet/egohands.data', help='*.data path')
    parser.add_argument('--weights', type=str, default='models/weights/yolov3-spp-ultralytics.pt', help='weights path')
