...
For a given dataformat, e.g `egohands.py`, if you wish to support reading in of your data format, define
...
class Ingestor:
    def validate(self, path):
        ...
        your format but have passed you a path to a directory that is missing the expected files or directory
        structure.
